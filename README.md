...
# Software Bombeiros Voluntários do Fundão

<table>
<tr>
<td>

> É possível o registo de utilizadores no sistema, como o acesso à sua área pessoal. Os utilizadores podem consultar as suas informações pessoais, bem como as informações relativas às ocorrências em que participaram.

> Inscrição para ser bombeiro voluntário, com a possibilidade de anexar documentos necessários para a inscrição. O utilizador pode consultar o estado da sua inscrição.

> Reportar um Incêndio.
...
[![HTML5][HTML5]][HTML5-url] [![CSS3][CSS3]][CSS3-url] [![PHP][PHP]][PHP-url] [![JavaScript][JavaScript]][JavaScript-url] [![JetBrains][JetBrains]][JetBrains-url]
...
Após a entrega deste projeto ficará público :  https://github.com/Software-Bombeiros-Voluntarios-do-Fundao
...
## [Prof. Doutor Sebastião País](https://sebastiaopais.github.io/)

## *Programação Web* @[Universidade da Beira Interior](https://www.ubi.pt/).
